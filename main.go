...
import (
	...
	"fmt"
	"log"
	"nart-ent-practice/ent"
	"nart-ent-practice/ent/car"
	"nart-ent-practice/ent/group"
	"nart-ent-practice/ent/user"
	"time"
...
func GetQueryGraph(ctx context.Context, client *ent.Client) error {
...
func TestQueryGraph(ctx context.Context, client *ent.Client) error {
